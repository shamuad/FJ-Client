        ...
        <Grid container spacing={24}>
          ...
          <Typography variant="h3" component="h3" >
           ...
           {data.getCampaignsDetails.ads.map(ad => (
              <Grid item xs={0.5} sm={9}><Paper className={classes.paperValues}>Video: <br/><Link to={`/clients/campaigns/${data.getCampaignsDetails.id}/video/${ad.id}`}>{ad.name}</Link></Paper></Grid>
           ))}     
        </Grid>
        {/* </Paper> */}
      </Grid>
